...
if CLIENT then
   ...
   SWEP.Icon = "vgui/weapons/weapon_mk2luger.vmt"

   -- Text shown in the equip menu
   SWEP.EquipMenuData = {
      type = "Weapon",
      desc = "Fire at your enemies to decrease their psyche and put them to sleep. This weapon is not lethal."
   };
end

if SERVER then
   resource.AddFile("materials/vgui/weapons/weapon_mk2luger.vmt")
end
