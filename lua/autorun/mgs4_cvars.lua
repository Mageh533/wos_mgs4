...
-- Client convars
CreateClientConVar( "mgs4_cqc_button", "110", true, true, "This is the BUTTON_CODE which handles the CQC button. If you don't know what this means, just use the mgs4_config command to set your button there." )
